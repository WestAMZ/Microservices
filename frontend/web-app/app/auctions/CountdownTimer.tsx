// to fix error (Super expression must either be null or a function), this happens when server side component has functions which needs to run on client side
'use client';
